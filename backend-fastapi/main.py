...
import config
from routers import auth, users, chat, checkin, notifications
...
app = FastAPI(
    title="AI 果树医生 API",
    description="基于 Kimi API 的果树病虫害诊断服务 + 用户管理系统",
    version="2.0.0"
)
...
async def health_check():
    ...
    健康检查接口
    """
    return {"status": "ok", "message": "AI 果树医生服务运行正常", "version": "2.0.0"}
...
@app.post("/shutdown", summary="关闭服务")
async def shutdown():
    """
    关闭服务接口
    """
