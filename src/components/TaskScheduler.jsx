    ...
    <div>
      <Tabs activeKey={activeTab} onChange={setActiveTab}>
        <TabPane tab="任务管理" key="tasks">
          <Card title={`${currentOrchard.name} - 任务管理`} extra={<Button type="primary" onClick={() => setModalVisible(true)}>添加任务</Button>}>
            <Table
